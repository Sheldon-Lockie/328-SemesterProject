...
/**
 * Spawns a heart to follow player and show health
 */
...
public class PlayerHealth extends BaseActor
{
    // player variables
    ...
    /**
     * Constructor for objects of class PlayerHealth
     */
    public PlayerHealth(float x, float y, Stage s)
    {
        super(x,y,s);
    ...
    {
        this.toFront();
        // will follow player and update health 
        followPlayer();
        updateHealth();
    }
    ...
    {
        setPosition(heroActor.getX() + 70, heroActor.getY() + 90);
        setSize(sizeX, sizeY);
        this.toFront();
    }
    ...
    {
        this.toFront();
        playerHealth = heroActor.retrieveHealth();
